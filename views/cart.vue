<template>
	<div class="cart">
		...
		<div class="cart-content">
			<div class="cart-content-main" v-for="(item,index) in cartList">
				...
				<div class="cart-count">
					<span class="cart-control-minus" @click="handleCount(index,-1)">-</span>{{item.count}}
		...
		<div class="cart-promotion" v-show="cartList.length">
			<span>使用优惠码：</span>
			<input type="text" name="" v-model="promotionCode">
...
.cart-header-main{
	padding:8px 32px;
	overflow:hidden;
	border-bottom:1px solid #dddeel;
	background:#eee;
	overflow:hidden;
}
.cart-empty{
